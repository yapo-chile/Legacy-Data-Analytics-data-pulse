...
class Database:
    ...
    def insert_data_current(self, data_dict: pd.DataFrame) -> None:
                ...
                .execute_values(cursor,
                                ...
                                """ ( dt_metric,
                                    ...
                                    VALUES %s; """, ((
                                        ...
                                        row.second_period,
                                        row.buyers_first_period,
                                        row.buyers_second_period,
                                        row.buyers_both_periods
    ...
    def insert_data_past(self, data_dict: pd.DataFrame) -> None:
